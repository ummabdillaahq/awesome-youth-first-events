...
2. run a find & replace of `ummabdillaahq/awesome-youth-first-events` with your details
3. edit `readme.md`
   - update the h1 title
   - update the subtitle
...
5. run a find & replace `readme.md` to `readme.md` in the CI you chose
5. delete this file
6. rename `readme.md` file to `readme.md`
